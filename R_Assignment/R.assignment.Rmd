...
#Question 1: Plot total number of SNPs per chromosome.
melt.snps <- melt(snps, "Chromosome", "SNP_ID")
ggplot(melt.snps) + geom_bar(aes(x=Chromosome, fill=Chromosome)) + ggtitle("SNPs on each Chromosome") + labs(x="Chromosome",y="SNP Count")
